...
class visualizeRT
{
    ...
    public:
       ...
       */
      visualizeRT(std::string cameraTopic, std::string laserTopic);

      ~visualizeRT();

};

visualizeRT::visualizeRT(std::string cameraTopic, std::string laserTopic) : nh("~")
{
...
int main(int argc, char* argv[])
{
    ...
    visualizeRT vl(cameraTopic, laserTopic);
    ros::spin();
