...
public:
   ...
   */
  headlessRT(std::string laserTopic, std::string cameraTopic);
  ~headlessRT()
  {
  }
...
headlessRT::headlessRT(std::string laserTopic, std::string cameraTopic) : nh("~")
{
...
int main(int argc, char* argv[])
{
  ...
  headlessRT hdless(laserTopic, cameraTopic);
  ros::spin();
  return 0;
}
